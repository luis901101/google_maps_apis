...
import 'package:google_maps_apis/src/legacy/directions.dart';
...
Future<void> main() async {
  ...
  group('Google Maps Directions', () {
    ...
    test('decode response', () {
      ...
      expect(
          response.routes?.first.bounds?.southwest.lng, equals(-118.2435600));
      ...
      expect(
          response.routes?.first.legs?.first.distance?.value, equals(2137146));
      expect(response.routes?.first.legs?.first.distance?.text,
          equals('1,328 mi'));
      expect(response.routes?.first.legs?.first.startLocation?.lat,
          equals(35.4675602));
      expect(response.routes?.first.legs?.first.startLocation?.lng,
          equals(-97.5164276));
      expect(response.routes?.first.legs?.first.endLocation?.lat,
          equals(34.0522342));
